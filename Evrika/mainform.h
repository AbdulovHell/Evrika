...
private: System::Windows::Forms::CheckBox^  RecalcNChk;
private: System::Windows::Forms::Label^  CoefNLbl;
...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->CoefNLbl = (gcnew System::Windows::Forms::Label());
				 this->RecalcNChk = (gcnew System::Windows::Forms::CheckBox());
				 ...
				 this->proglog->Location = System::Drawing::Point(1, 350);
				 ...
				 this->proglog->Size = System::Drawing::Size(482, 104);
				 ...
				 this->button10->Location = System::Drawing::Point(3, 325);
				 ...
				 this->TagAndRepInfoBox->Controls->Add(this->CoefNLbl);
				 this->TagAndRepInfoBox->Controls->Add(this->RecalcNChk);
				 ...
				 this->TagAndRepInfoBox->Size = System::Drawing::Size(302, 114);
				 this->TagAndRepInfoBox->TabIndex = 24;
				 this->TagAndRepInfoBox->TabStop = false;
				 this->TagAndRepInfoBox->Text = L"groupBox3";
				 this->CoefNLbl->AutoSize = true;
				 this->CoefNLbl->Location = System::Drawing::Point(165, 89);
				 this->CoefNLbl->Name = L"CoefNLbl";
				 this->CoefNLbl->Size = System::Drawing::Size(116, 13);
				 this->CoefNLbl->TabIndex = 6;
				 this->CoefNLbl->Text = L"Коэф. среды N=2.472";
				 this->RecalcNChk->AutoSize = true;
				 this->RecalcNChk->Enabled = false;
				 this->RecalcNChk->Location = System::Drawing::Point(6, 88);
				 this->RecalcNChk->Name = L"RecalcNChk";
				 this->RecalcNChk->Size = System::Drawing::Size(86, 17);
				 this->RecalcNChk->TabIndex = 5;
				 this->RecalcNChk->Text = L"Перерасчет";
				 this->RecalcNChk->UseVisualStyleBackColor = true;
